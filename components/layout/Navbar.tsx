    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-18">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-3 group" aria-label="CSEDUSC Home">
            <div className="flex items-center gap-2">
              ...
              <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-white/30 flex-shrink-0 -ml-2">
                <img
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button
              ...
              className={cn(
                ...
                isHomePage && !scrolled
                  ? "text-white/80 hover:text-white hover:bg-white/10"
                  : "text-gray-500 hover:text-primary hover:bg-surface/50"
              )}
                ...
                <AnimatePresence>
                  {userMenuOpen && (
                    ...
                    >
                      ...
                      <Link
                        href="/dashboard"
                        className="flex items-center gap-2 px-4 py-2.5 text-sm text-gray-700 hover:bg-surface/50 transition-colors"
          ...
          >
            <div className="px-4 py-4 space-y-1">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive(link.href)
                      ...
                      : "text-gray-600 hover:bg-surface/50 hover:text-primary"
                  )}
                >
                  {link.label}
                </Link>
              ...
              <div className="border-t border-slate-100 pt-3 mt-3 space-y-2">
                <button
                  onClick={toggle}
                  className="flex items-center gap-2 px-4 py-2 text-sm text-gray-500 hover:text-primary"
                >
                  <Globe className="w-4 h-4" />
                ...
                {user ? (
                  <>
                    <Link href="/dashboard" className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-surface/50 rounded-lg">
                      {t("nav.dashboard")}
                    </Link>
                    <Link href="/profile" className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-surface/50 rounded-lg">
                      {t("nav.profile")}
                    </Link>
                    <button
